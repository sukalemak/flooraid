                    ...
                    <div className="col-sm-12 col-lg-12">
                        <form onSubmit={this.handleSubmit}>
                            <fieldset>
                                ...
                                <input type="file" id="file_upload" ref={this.fileInput} name="file_upload" accept="image/*" capture="camera" className="inputfile" data-multiple-caption="{count} files selected" multiple />
                                <label htmlFor="file_upload"><span>Upload image</span></label>
